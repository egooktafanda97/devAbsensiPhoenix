...
if(v.isNumber(minimum)&&length<minimum){err=options.tooShort||this.tooShort||"terlalu pendek (gunakan minimal  %{count} huruf)";errors.push(v.format(err,{count:minimum}));}
