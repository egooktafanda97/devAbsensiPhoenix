                ...
                <div class="container-fluid" style="padding-top:7.5em;">
                    ...
                    <div class="row text-white">
                        <div class="col-2 text-center">
                            <i class="fa fa-credit-card" style="font-size:2.7em;"></i>
                        </div>
                        <div class="col-10">
                            <h1 class="h4 mb-0 ">Pembayaran</h1>
    ...
    <script type="text/javascript"> 
        ...
        $("#topBg").attr("src", 'https://sdmusix.com/wp-content/uploads/2020/07/abstract-futuristic-background_23-2148392654.jpg');
        ...
        function loadPesertaDidik(){
            ...
            const save2 = async ()=>{
                      ...
                      if(posts2.status==200){
                            ...
                            posts2.data.all.map((mapping2,i2)=>{
                                    ...
                                    }else if(mapping2.status_transaksi=='SUCCESS'){
                                        sts =  'btn-success';
                                        ststext = 'SUKSES';
                                    }else {
                                        sts =  'btn-dark';
                                    ...
                                    sintaks +=`
                                    <div class="col-12 mb-4">
                                        <div class="card shadow h-100 py-1" style="border:none;" onclick="showDetailInvoice('${mapping2.key_reference}','${ststext}')">
                                            <div class="card-body">
                                                <div class="row ">
                                                    
                                                    <div class="col-12">
                                                    <font class="${sts}" style="padding:5px; padding-left:20px; padding-right:20px;border-radius:1000px;float:right; font-size:.7em;">${ststext}</font>
                                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb">
                                                            <font style="font-size:1.5em; font-weight:bold;">${mapping2.va}</font>
                                                            <font class="text-dark" style="font-size:1em; font-weight:normal;display:block;">${moment(mapping2.expired_at).format('Do MMMM YYYY | H:mm:ss')+' WIB'}</font>
                                                        </div>
            ...
            if(status=='EXPIRED'){
                    $(".loading").fadeOut();
                      Swal.fire({
                          ...
                          text: 'Transaksi ini gagal karena telah melewati batas waktu yang telah ditentukan. Silahkan buat kembali permohonan pembayaran.',
                          showConfirmButton: true,
                          
                        });
            }else {
                const save = async (check)=>{
                  const posts = await axios.get('<?=api_url();?>payment/get-by-kode/'+check, {
                      headers: {'Authorization': 'Bearer '+ sessionStorage.getItem('_token')}
                  }).catch((err)=>{
                  ...
                  if(posts.status==200){
                      $(".loading").fadeOut();
                        ...
                        let dn='';
                        let prc = '';
                        let mtd = posts.data.method.toUpperCase();
                        if(posts.data.displayName!=''){
                         dn = posts.data.display_name;
                        }else {
                            dn = 'Masih kosong';
                        }
                        
                        if(posts.data.price!=''){
                         prc = posts.data.jumlah;
                        }else {
                            prc = '0';
                        }
                         ...
                         Swal.fire({
                          ...
                          icon: stloader,
                          title: '<h5>'+status+'</h5>',
                          html: '<h6>Detail pengiriman : </h6><table class="table table-bordered text-left" style="width:100%;font-size:.8em;color:#fff;"><tr><td width="100">VA</td><td width="500">'+posts.data.va+'</td></tr><tr><td width="100">Nama</td><td width="500">'+dn+'</td></tr><tr><td width="100">Metode</td><td width="500">'+mtd+'</td></tr><tr><td width="100">Tagihan</td><td width="500">Rp '+formatRupiah(prc)+'</td></tr><tr><td width="100">Waktu</td><td width="500">'+moment(posts.data.updated_at).format('Do MMMM YYYY, H:mm:ss')+' WIB'+'</td></tr></table>',
                          showConfirmButton: true,
                          showDenyButton: false,
                          showCancelButton: false,
                          confirmButtonText: 'Tutup',
