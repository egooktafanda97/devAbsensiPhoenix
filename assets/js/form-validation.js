...
$(document).ready(function () {
    ...
    var constraints = {
        "nomor-surat": { presence: true, length: { minimum: 10 } },
        mySelect2: { presence: true },
        email: { presence: true, email: true },
        password: { presence: true, length: { minimum: 5 } },
        "repeat-password": { presence: true, equality: { attribute: "password", message: "^The passwords does not match" } },
        name: { presence: true, length: { minimum: 3, maximum: 20 }, format: { pattern: "[a-z0-9]+", flags: "i", message: "can only contain a-z and 0-9" } },
        addon: { presence: true, length: { minimum: 3, maximum: 20 }, format: { pattern: "[a-z0-9]+", flags: "i", message: "can only contain a-z and 0-9" } },
        maxlength: { presence: true, numericality: { onlyNumeric: true, greaterThan: 10 } },
        minlength: { presence: true, numericality: { onlyNumeric: true, lessThan: 5 } },
    ...
    var constraints1 = { Username: { presence: true, length: { minimum: 3, maximum: 20 }, format: { pattern: "[a-z0-9]+", flags: "i", message: "can only contain a-z and 0-9" } }, Email: { presence: true, email: true } };
    ...
    var constraints2 = {
        ...
        Number: { presence: true, numericality: { onlyNumeric: true, greaterThan: 50 } },
        Numbers: { presence: true, numericality: { onlyNumeric: true, lessThan: 50 } },
    };
    ...
    var constraints3 = { member: { presence: true }, Language: { presence: true } };
