...
<head>
<meta charset="utf-8">
<title>Error! Pencarian tidak ditemukan </title>
...
@media screen and (max-width: 1000px) {
  ...
  .buttn:hover {
    ...
    border-radius: 100px;
    box-shadow: 0px 10px 12px #f2f2f2;
    background: #e1e1e1
...
<div class="container">
        <div class="error">
            ...
            <p>Terjadi kesalahan dalam pencarian data. Silahkan coba kembali.</p>

            <button id="backHome" onclick="backHome()" class="buttn"><i class="fa fa-arrow-left" style="margin-right: 10px;"></i>Kembali ke halaman utama</button>
        </div>
